...
if [[ $? -eq 0 ]]; then
	...
	/usr/local/bin/sendEmail -f photomac@ozarkandpeach.com  -t tylerkspencer@gmail.com -u "Power Failure Notification" -s smtp.gmail.com:587 -o message-file=/Users/tylerkspencer/iCloudDocs/Personal\ Projects/Power\ Failure/ps_output.txt -o tls=yes -xu tylerkspencer -xp jipvnemieodclrxj > /dev/null 2>&1
